...
Gfx *geo_update_projectile_pos_from_parent(s32 callContext, UNUSED struct GraphNode *node, const ShortMatrix* mtx);
...
void obj_apply_scale_to_mtxq(struct Object *obj, ShortMatrix* dst, ShortMatrix* src);
...
s32 approach_q32_signed(q32 *valueq, q32 targetq, q32 incrementq);
...
void cur_obj_shake_yq(q32 amount);
...
void cur_obj_push_mario_away(s32 radius);
void cur_obj_push_mario_away_from_cylinder(s32 radius, s32 extentY);
