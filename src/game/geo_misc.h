...
extern s16 roundq(q32);
extern Gfx *geo_exec_inside_castle_light(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtxq);
extern Gfx *geo_exec_flying_carpet_timer_update(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtxq);
extern Gfx *geo_exec_flying_carpet_create(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtxq);
extern Gfx *geo_exec_cake_end_screen(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtxq);
