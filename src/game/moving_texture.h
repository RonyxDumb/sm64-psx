...
Gfx *geo_wdw_set_initial_water_level(s32 callContext, UNUSED struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_pause_control(s32 callContext, UNUSED struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_water_regions(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_nocolor(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_colored(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_colored_no_update(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_colored_2_no_update(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_update_horizontal(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
Gfx *geo_movtex_draw_colored_no_update(s32 callContext, struct GraphNode *node, UNUSED const ShortMatrix* mtx);
