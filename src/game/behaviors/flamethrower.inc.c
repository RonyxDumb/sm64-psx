...
void bhv_flamethrower_flame_loop(void) {
    ...
    if (o->oBehParams2ndByte == 2)
        sizeq = o->oTimer * (QFIELD(o, oForwardVel) - q(6)) / 100 + q(2);
    else
        sizeq = o->oTimer * (QFIELD(o, oForwardVel) - q(20)) / 100 + q(1);
    if (o->oBehParams2ndByte == 3) {
        o->hitboxHeight_s16 = 200;
        o->hitboxDownOffset_s16 = 150;
        QSETFIELD(o, oVelY, q(-28));
        cur_obj_update_floor_height();
        if (QFIELD(o, oPosY) - sizeq * 25 < QFIELD(o, oFloorHeight)) {
            QSETFIELD(o, oVelY, q(0));
            QSETFIELD(o, oPosY, QFIELD(o, oFloorHeight) + sizeq * 25);
        }
    ...
    if (o->oBehParams2ndByte == 4)
        QMODFIELD(o, oPosY, += QFIELD(o, oForwardVel)); // weird?
    else
...
void bhv_flamethrower_loop(void) {
    ...
    if (o->oAction == 0) {
        ...
        FSETFIELD(flame, oForwardVel, flameVel);
