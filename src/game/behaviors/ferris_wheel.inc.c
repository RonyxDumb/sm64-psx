...
void bhv_ferris_wheel_platform_update(void) {
    ...
    FSETFIELD(o, oPosX, FFIELD(o->parentObj, oPosX) + offsetXZ * sins(o->parentObj->oMoveAngleYaw)
               + 300.0f * coss(o->parentObj->oMoveAngleYaw));

    FSETFIELD(o, oPosY, FFIELD(o->parentObj, oPosY) + 400.0f * sins(offsetAngle));

    FSETFIELD(o, oPosZ, FFIELD(o->parentObj, oPosZ) + offsetXZ * coss(o->parentObj->oMoveAngleYaw)
