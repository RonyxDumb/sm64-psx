...
void koopa_shell_spawn_water_drop(void) {
    ...
    if (gMarioStates[0].forwardVel > 10.0f) {
        ...
        QSETFIELD(drop, oVelY, random_q32() * 30);
...
void bhv_koopa_shell_flame_loop(void) {
    if (o->oTimer == 0) {
        ...
        QSETFIELD(o, oVelY, random_q32() * 30);
        QSETFIELD(o, oGravity, q(-4.0f));
        o->oAnimState = random_float() * 10.0f;
        obj_translate_xz_random(o, 110.0f);
        QSETFIELD(o, oKoopaShellFlameUnkF8, q(4));
    }
    cur_obj_update_floor_height();
    cur_obj_move_using_fvel_and_gravity();
    if (QFIELD(o, oFloorHeight) > QFIELD(o, oPosY) || o->oTimer > 10)
        obj_mark_for_deletion(o);
    QMODFIELD(o, oKoopaShellFlameUnkF8, += q(-0.3));
    cur_obj_scaleq(QFIELD(o, oKoopaShellFlameUnkF8));
}
...
void koopa_shell_spawn_sparklesq(q32 aq) {
    struct Object *sp1C = spawn_object(o, MODEL_NONE, bhvSparkleSpawn);
    QMODFIELD(sp1C, oPosY, += aq);
}
...
void bhv_koopa_shell_loop(void) {
    ...
    switch (o->oAction) {
        case 0:
            ...
            koopa_shell_spawn_sparklesq(q(10.0f));
            break;
        case 1:
            obj_copy_pos(o, gMarioObject);
            sp34 = cur_obj_update_floor_height_and_get_floor();
            if (ABS(find_water_levelq(QFIELD(o, oPosX), QFIELD(o, oPosZ)) - QFIELD(o, oPosY)) < q(10))
                koopa_shell_spawn_water_drop();
            else if (q(5) > ABS(QFIELD(o, oPosY) - QFIELD(o, oFloorHeight))) {
