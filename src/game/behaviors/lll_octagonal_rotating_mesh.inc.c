...
s32 lll_octagonal_mesh_move(s16 *a0, s32 a1) {
    switch (a0[a1]) {
        case 4:
            ...
            FSETFIELD(o, oForwardVel, a0[a1 + 3] / 100.0f);
        ...
        case 2:
            ...
            break;
        case 1:
            APPROACH_F32_FIELD(o, oForwardVel, a0[a1 + 2] / 100.0f, a0[a1 + 3] / 100.0f);
            if (o->oTimer > a0[a1 + 1]) {
                a1 += 4;
                o->oTimer = 0;
            }
...
void bhv_lll_moving_octagonal_mesh_platform_loop(void) {
	...
	f32 horizontalMovementUnk108 = FFIELD(o, oHorizontalMovementUnk108);
    if (lll_octagonal_mesh_find_y_offset(&o->oHorizontalMovementUnk104, &horizontalMovementUnk108, 0x400, -80)) {
        o->oHorizontalMovementUnkF4 += 0x800;
        QMODFIELD(o, oHorizontalMovementUnk100, -= sinqs(o->oHorizontalMovementUnkF4) * 2);
    }
	FSETFIELD(o, oHorizontalMovementUnk108, horizontalMovementUnk108);
    QSETFIELD(o, oPosY, QFIELD(o, oHorizontalMovementUnk100) + QFIELD(o, oHomeY) + QFIELD(o, oHorizontalMovementUnk108));
}
