...
void bhv_blue_fish_movement_loop(void) {
    ...
    switch (o->oAction) {
        ...
        case BLUE_FISH_ACT_DIVE:
            ...
            if (o->oTimer == 0) {
                QSETFIELD(o, oBlueFishRandomAngle, q(random_sign() << 11));
                QSETFIELD(o, oBlueFishRandomVel, random_q32() * 2);
            ...
            QSETFIELD(o, oForwardVel, QFIELD(o, oBlueFishRandomVel) + q(3));
            ...
            QSETFIELD(o, oVelY, qmul(-sinqs(o->oFaceAnglePitch), QFIELD(o, oForwardVel)));
            break;
        // Animates and adjusts fish yaw angle.
        case BLUE_FISH_ACT_TURN:
            cur_obj_init_animation_with_accel_and_sound(0, 2.0f);
            o->oMoveAngleYaw = (s32)(FFIELD(o, oBlueFishRandomAngle) + o->oMoveAngleYaw);
            if (o->oTimer == 15) {
                o->oAction++;
            }
            break;
