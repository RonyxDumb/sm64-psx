...
static Gfx gd_dl_sparkle_red_color[] = {
    gsDPSetEnvColor(0, 0, 255, 255),//gsDPSetPrimColor(0, 0, 255, 0, 0, 255),
    gsSPEndDisplayList(),
};

static Gfx gd_dl_sparkle_white_color[] = {
    gsDPSetEnvColor(255, 255, 255, 255),//gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPEndDisplayList(),
};
...
extern __attribute__((aligned(8))) u8 _gd_dynlistsSegmentRomStart[];
extern __attribute__((aligned(8))) u8 _gd_dynlistsSegmentRomEnd[];
 ...
 * Unused
 */
f32 stub_renderer_1(UNUSED f32 x) {
    return 0.0;
}
...
void mat4f_to_mtx(Mat4f *src, Mtx *dst) {
#ifndef GBI_FLOATS
    s32 i; // 14
    s32 j; // 10
    s32 w1;
...
void gd_dl_mul_matrix(Mat4f *mtx) {
    mat4f_to_mtx(mtx, &DL_CURRENT_MTX(sCurrentGdDl));
...
void gd_dl_lookat(struct ObjCamera *cam, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7) {
    ...
    mat4f_to_mtx(&cam->unkE8, &DL_CURRENT_MTX(sCurrentGdDl));
    gSPMatrix(next_gfx(), osVirtualToPhysical(&DL_CURRENT_MTX(sCurrentGdDl)),
...
void gd_init(void) {
    ...
    mat4f_to_mtx(&sInitIdnMat4, &sIdnMtx);
