    ...
    while (link != NULL) {
        ...
        switch (animData->type) {
            ...
            case GD_ANIM_ROT3S: // data = s16(*)[3] - rotation only
                ...
                nextTransform.pos.y = currTransform.pos.y + Y_OFF;
                nextTransform.pos.z = currTransform.pos.z + Z_OFF;
            ...
            case GD_ANIM_POS3S: // data = s16(*)[3] - position only
                ...
                currTransform.pos.y = (f32) animData3s16[currKeyFrame][1] + Y_OFF;
                currTransform.pos.z = (f32) animData3s16[currKeyFrame][2] + Z_OFF;

                nextTransform.pos.x = (f32) animData3s16[nextKeyFrame][0];
                nextTransform.pos.y = (f32) animData3s16[nextKeyFrame][1] + Y_OFF;
                nextTransform.pos.z = (f32) animData3s16[nextKeyFrame][2] + Z_OFF;
            ...
            case GD_ANIM_ROT3S_POS3S: // data = s16(*)[6] - rotation and position
                ...
                currTransform.pos.y  = (f32) animData6s16[currKeyFrame][4] + Y_OFF;
                currTransform.pos.z  = (f32) animData6s16[currKeyFrame][5] + Z_OFF;

                nextTransform.pos.x  = (f32) animData6s16[nextKeyFrame][3];
                nextTransform.pos.y  = (f32) animData6s16[nextKeyFrame][4] + Y_OFF;
                nextTransform.pos.z  = (f32) animData6s16[nextKeyFrame][5] + Z_OFF;
            ...
            case GD_ANIM_SCALE3S_POS3S_ROT3S: // data = s16(*)[9] - scale, position, and rotation
                ...
                currTransform.pos.y  = (f32) animData9s16[currKeyFrame][7] + Y_OFF;
                currTransform.pos.z  = (f32) animData9s16[currKeyFrame][8] + Z_OFF;
                ...
                nextTransform.pos.y  = (f32) animData9s16[nextKeyFrame][7] + Y_OFF;
                nextTransform.pos.z  = (f32) animData9s16[nextKeyFrame][8] + Z_OFF;
            ...
            case GD_ANIM_CAMERA_EYE3S_LOOKAT3S: // s16(*)[6]?
                if (linkedObj->type == OBJ_TYPE_CAMERAS) {
                    ...
                    ((struct ObjCamera *) linkedObj)->worldPos.y = currTransform.pos.y + Y_OFF;
                    ((struct ObjCamera *) linkedObj)->worldPos.z = currTransform.pos.z + Z_OFF;

                    ((struct ObjCamera *) linkedObj)->lookAt.x = nextTransform.pos.x;
                    ((struct ObjCamera *) linkedObj)->lookAt.y = nextTransform.pos.y + Y_OFF;
                    ((struct ObjCamera *) linkedObj)->lookAt.z = nextTransform.pos.z + Z_OFF;
                }
                break;
