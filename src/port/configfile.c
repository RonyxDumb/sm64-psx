...
unsigned int configKeyA = 50;
unsigned int configKeyB = 49;
unsigned int configKeyStart = 28;
unsigned int configKeyR = 54;
unsigned int configKeyZ = 57;
unsigned int configKeyCUp = 23;
unsigned int configKeyCDown = 37;
unsigned int configKeyCLeft = 36;
unsigned int configKeyCRight = 38;
unsigned int configKeyStickUp = 17;
unsigned int configKeyStickDown = 31;
unsigned int configKeyStickLeft = 30;
unsigned int configKeyStickRight = 32;
