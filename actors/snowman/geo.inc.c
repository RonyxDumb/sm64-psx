         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_OPAQUE, 490, 14, 43, 305, 0, 248, DYN_mario_cap_seg3_dl_03022F48),
                  GEO_CLOSE_NODE(),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_ASM_DYN(0, DYN_geo_update_projectile_pos_from_parent),
               GEO_CLOSE_NODE(),
            GEO_CLOSE_NODE(),
            GEO_ANIMATED_PART(LAYER_OPAQUE, 356, 0, 0, NULL),
         GEO_CLOSE_NODE(),
