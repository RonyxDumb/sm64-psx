                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM_DYN(0, DYN_geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_OPAQUE, 0, 100, 0, 180, 270, 0, DYN_mario_cap_seg3_dl_03022F48),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                           GEO_NODE_START(),
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM_DYN(0, DYN_geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_OPAQUE, 0, 100, 0, 180, 270, 0, DYN_star_seg3_dl_0302B870),
                                 GEO_ASM_DYN(0, DYN_geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_ALPHA, 0, 100, 0, 180, 270, 0, DYN_star_seg3_dl_0302BA18),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                           GEO_NODE_START(),
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM_DYN(0, DYN_geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_OPAQUE, 0, 100, 0, 180, 270, 0, DYN_transparent_star_seg3_dl_0302C620),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
