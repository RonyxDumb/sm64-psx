...
const GeoLayout mario_geo_face_and_wings[] = {
   GEO_ASM_DYN(0, DYN_geo_mario_head_rotation),
   GEO_ROTATION_NODE(0x00, 0, 0, 0),
   GEO_OPEN_NODE(),
      GEO_SWITCH_CASE_DYN(0, DYN_geo_switch_mario_cap_on_off),
      GEO_OPEN_NODE(),
         GEO_SWITCH_CASE_DYN(0, DYN_geo_switch_mario_eyes),
         GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(0, DYN_geo_mario_rotate_wing_cap_wings),
         GEO_ROTATION_NODE(0x00, 0, 0, 0),
         GEO_OPEN_NODE(),
      ...
      GEO_TRANSLATE_ROTATE(0, 142, -51, 126, -22, 40, -135),
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(1, DYN_geo_mario_rotate_wing_cap_wings),
         GEO_ROTATION_NODE(0x00, 0, 0, 0),
         GEO_OPEN_NODE(),
...
const GeoLayout mario_geo_left_hand[] = {
   GEO_SWITCH_CASE_DYN(1, DYN_geo_switch_mario_hand),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_OPAQUE, 60, 0, 0, NULL),
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(1, DYN_geo_mario_hand_foot_scaler),
...
const GeoLayout mario_geo_right_hand[] = {
   GEO_SWITCH_CASE_DYN(0, DYN_geo_switch_mario_hand),
   GEO_OPEN_NODE(),
      GEO_ANIMATED_PART(LAYER_OPAQUE, 60, 0, 0, NULL),
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(0, DYN_geo_mario_hand_foot_scaler),
         GEO_SCALE(0x00, 65536),
         GEO_OPEN_NODE(),
            GEO_DISPLAY_LIST(LAYER_OPAQUE, mario_right_hand_closed),
         GEO_CLOSE_NODE(),
         GEO_HELD_OBJECT_DYN(0x00, 0, 0, 0, DYN_geo_switch_mario_hand_grab_pos),
      GEO_CLOSE_NODE(),
...
const GeoLayout mario_geo_body[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(0, DYN_geo_move_mario_part_from_parent),
         GEO_ASM_DYN(0, DYN_geo_mario_tilt_torso),
         GEO_ROTATION_NODE(0x00, 0, 0, 0),
         GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     GEO_ASM_DYN(2, DYN_geo_mario_hand_foot_scaler),
                     GEO_SCALE(0x00, 65536),
                     GEO_OPEN_NODE(),
...
const GeoLayout mario_geo_load_body[] = {
   GEO_SWITCH_CASE_DYN(0, DYN_geo_switch_mario_cap_effect),
   GEO_OPEN_NODE(),
...
const GeoLayout mario_geo[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_ASM_DYN(0, DYN_geo_mirror_mario_backface_culling),
         GEO_ASM_DYN(0, DYN_geo_mirror_mario_set_alpha),
         GEO_SWITCH_CASE_DYN(0, DYN_geo_switch_mario_stand_run),
         GEO_OPEN_NODE(),
            GEO_BRANCH(1, mario_geo_load_body),
            GEO_BRANCH(1, mario_geo_render_body),
         GEO_CLOSE_NODE(),
         GEO_ASM_DYN(1, DYN_geo_mirror_mario_backface_culling),
      GEO_CLOSE_NODE(),
   GEO_CLOSE_NODE(),
   GEO_END(),
};
