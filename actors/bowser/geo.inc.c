      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_ASM_DYN(0, DYN_geo_update_body_rot_from_parent),
            GEO_CLOSE_NODE(),
         GEO_CLOSE_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_CLOSE_NODE(),
               GEO_SWITCH_CASE_DYN(9, DYN_geo_switch_bowser_eyes),
               GEO_OPEN_NODE(),
...
const GeoLayout bowser_geo[] = {
   ...
   GEO_OPEN_NODE(),
...
#ifndef VERSION_JP
      GEO_SWITCH_CASE_DYN(3, DYN_geo_switch_anim_state),
#else
      ...
      GEO_OPEN_NODE(),
         GEO_NODE_START(),
         GEO_OPEN_NODE(),
            GEO_ASM_DYN(0, DYN_geo_bits_bowser_coloring),
