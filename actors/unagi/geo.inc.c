                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              GEO_SCALE(0x00, 16384),
                              GEO_OPEN_NODE(),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_OPAQUE, 2000, 0, 0, 0, 0, 0, DYN_star_seg3_dl_0302B870),
                                 GEO_TRANSLATE_ROTATE_WITH_DL_DYN(LAYER_ALPHA, 2000, 0, 0, 0, 0, 0, DYN_star_seg3_dl_0302BA18),
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
