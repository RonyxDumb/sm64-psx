...
LEVEL_SCRIPTGEO_FILES := $(addsuffix scriptgeo,$(LEVEL_DIRS))
...
SEG_FILES_WITH_GEO := \
	$(SEGMENTS:%=$(BUILD_DIR)/bin/%.elf) \
	$(ACTOR_GROUPS:%=$(BUILD_DIR)/actors/%.elf) \
	$(ACTOR_GROUPS:%=$(BUILD_DIR)/actors/%_geo.elf) \
	$(LEVEL_FILES:%=$(BUILD_DIR)/levels/%.elf) \
	$(LEVEL_SCRIPTGEO_FILES:%=$(BUILD_DIR)/levels/%.elf) \
	$(BUILD_DIR)/assets/mario_anim_data.elf \
	$(BUILD_DIR)/assets/demo_data.elf

# the address doesn't matter for these
$(BUILD_DIR)/assets/mario_anim_data.elf: SEGMENT_ADDRESS := 0x00000000
$(BUILD_DIR)/assets/demo_data.elf: SEGMENT_ADDRESS := 0x00000000

BIN_SEG_FILES := $(SEGMENTS:%=$(BUILD_DIR)/bin/%.elf)
GROUP_SEG_FILES := $(ACTOR_GROUPS:%=$(BUILD_DIR)/actors/%.elf)
LEVEL_SEG_FILES := $(LEVEL_FILES:%=$(BUILD_DIR)/levels/%.elf)
...
MIO0_OBJ_FILES := $(MIO0_FILES:.mio0=.mio0.o2)
...
# Actor dependencies
$(BUILD_DIR)/actors/group0.o2:  $(MARIO_WATER_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group1.o2:  $(HOOT_THWOMP_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group2.o2:  $(BULLY_BLARGG_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group3.o2:  $(BOBOMBS_BUBBLE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group4.o2:  $(SEA_CREATURES_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group5.o2:  $(KLEPTO_EYEROK_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group6.o2:  $(MOLE_UKIKI_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group7.o2:  $(SPINDRIFT_PENGUIN_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group8.o2:  $(CAPSWITCH_SPRINGBOARD_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group9.o2:  $(BOO_BOOKEND_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group10.o2: $(PEACH_TOADSTOOL_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group11.o2: $(BUBBA_WIGGLER_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group12.o2: $(BOWSER_FLAMES_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group13.o2: $(SKEETER_FISH_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group14.o2: $(KOOPA_LOG_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group15.o2: $(LAKITU_TOAD_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group16.o2: $(CHILLYCHIEF_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/group17.o2: $(MR_I_SWOOP_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/common0.o2: $(AMP_CHUCKYA_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/actors/common1.o2: $(COINS_PIPE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)

# Actor Elf Files
$(BUILD_DIR)/actors/group0.elf:  SEGMENT_ADDRESS := 0x04000000
$(BUILD_DIR)/actors/group0_geo.elf:  SEGMENT_ADDRESS := 0x17000000
$(BUILD_DIR)/actors/group1.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group1_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group2.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group2_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group3.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group3_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group4.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group4_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group5.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group5_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group6.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group6_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group7.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group7_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group8.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group8_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group9.elf:  SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group9_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group10.elf: SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group10_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group11.elf: SEGMENT_ADDRESS := 0x05000000
$(BUILD_DIR)/actors/group11_geo.elf: SEGMENT_ADDRESS := 0x0C000000
$(BUILD_DIR)/actors/group12.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group12_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/group13.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group13_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/group14.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group14_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/group15.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group15_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/group16.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group16_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/group17.elf: SEGMENT_ADDRESS := 0x06000000
$(BUILD_DIR)/actors/group17_geo.elf: SEGMENT_ADDRESS := 0x0D000000
$(BUILD_DIR)/actors/common0.elf: SEGMENT_ADDRESS := 0x08000000
$(BUILD_DIR)/actors/common0_geo.elf: SEGMENT_ADDRESS := 0x0F000000
$(BUILD_DIR)/actors/common1.elf: SEGMENT_ADDRESS := 0x03000000
$(BUILD_DIR)/actors/common1_geo.elf: SEGMENT_ADDRESS := 0x16000000
...
$(BUILD_DIR)/levels/%/scriptgeo.elf: SEGMENT_ADDRESS := 0x0E000000

# TODO: Generate these rules from the level configs?

define level_rules =
	$(1)_SEG7_FILES     := $$(patsubst %.png,%.inc.c,$$(wildcard levels/$(1)/*.png))
	$$(BUILD_DIR)/levels/$(1)/leveldata.o2: $$(addprefix $$(BUILD_DIR)/,$$($(1)_SEG7_FILES))
...
>	$(V)mkdir -p $(BUILD_DIR)/levels/ending
>	$(V)touch $@
...
# Texture Files
$(BUILD_DIR)/bin/segment2.o2:        $(SEGMENT2_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/title_screen_bg.o2: $(TITLE_SCREEN_BG_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/spooky.o2:          $(SPOOKY_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/generic.o2:         $(GENERIC_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/outside.o2:         $(OUTSIDE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/snow.o2:            $(SNOW_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/effect.o2:          $(EFFECT_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/cave.o2:            $(CAVE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/inside.o2:          $(INSIDE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/water.o2:           $(WATER_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/fire.o2:            $(FIRE_TEXTURES_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/sky.o2:             $(SKY_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/machine.o2:         $(MACHINE_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/mountain.o2:        $(MOUNTAIN_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
$(BUILD_DIR)/bin/grass.o2:           $(GRASS_TEXTURES:%.png=$(BUILD_DIR)/%.inc.c)
