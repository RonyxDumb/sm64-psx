...
const LevelScript level_bowser_1_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO_DYN(MODEL_LEVEL_GEOMETRY_03, DYN_bowser_1_yellow_sphere_geo),

    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ 0, 1307, 0, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ DYN_bhvSpinAirborneCircleWarp),
