...
const GeoLayout geo_bbh_000828[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(0x0400, DYN_geo_movtex_draw_water_regions),
      GEO_ASM_DYN(0x0401, DYN_geo_movtex_draw_water_regions),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout geo_bbh_000F00[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         GEO_NODE_ORTHO(100),
         GEO_OPEN_NODE(),
            GEO_BACKGROUND_DYN(BACKGROUND_HAUNTED, DYN_geo_skybox_main),
         GEO_CLOSE_NODE(),
      GEO_CLOSE_NODE(),
      GEO_ZBUFFER(1),
      GEO_OPEN_NODE(),
         GEO_CAMERA_FRUSTUM_WITH_FUNC_DYN(45, 50, 10000, DYN_geo_camera_fov),
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(4, 0, 2000, 6000, 0, 0, 0, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE_DYN(32, DYN_geo_switch_area),
               GEO_OPEN_NODE(),
