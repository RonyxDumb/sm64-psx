...
const GeoLayout castle_grounds_geo_00073C[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(16, 0, 1500, 2500, 0, 1500, -12000, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               ...
               GEO_ASM_DYN(0x1601, DYN_geo_movtex_draw_nocolor),
               GEO_ASM_DYN(0x1601, DYN_geo_movtex_draw_water_regions),
               GEO_RENDER_OBJ(),
