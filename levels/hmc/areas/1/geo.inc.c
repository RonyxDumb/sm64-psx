...
const GeoLayout hmc_geo_000658[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(0x0702, DYN_geo_movtex_draw_water_regions),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout hmc_geo_000700[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(0, DYN_geo_movtex_pause_control),
      GEO_ASM_DYN(0x0701, DYN_geo_movtex_draw_water_regions),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout hmc_geo_000748[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(PAINTING_ID(0, 0), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE_DYN(18, DYN_geo_switch_area),
               GEO_OPEN_NODE(),
