...
const GeoLayout castle_geo_001578[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(PAINTING_ID(8, 1), DYN_geo_painting_draw),
      GEO_ASM_DYN(PAINTING_ID(10, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0015B8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(12, 1), DYN_geo_painting_draw),
      GEO_ASM_DYN(  0, DYN_geo_render_mirror_mario),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0015F8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(9, 1), DYN_geo_painting_draw),
      GEO_ASM_DYN(PAINTING_ID(13, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001628[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(11, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001858[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ZBUFFER(1),
      GEO_OPEN_NODE(),
         GEO_CAMERA_FRUSTUM_WITH_FUNC_DYN(64, 50, 8000, DYN_geo_camera_fov),
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(4, 0, 2000, 6000, 0, 0, 0, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE_DYN(11, DYN_geo_switch_area),
               GEO_OPEN_NODE(),
