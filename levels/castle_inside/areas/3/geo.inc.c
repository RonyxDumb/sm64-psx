...
const GeoLayout castle_geo_001980[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN( PAINTING_ID(4, 1), DYN_geo_painting_draw),
      GEO_ASM_DYN( PAINTING_ID(5, 1), DYN_geo_painting_draw),
      GEO_ASM_DYN(   0, DYN_geo_movtex_pause_control),
      GEO_ASM_DYN(0x0600, DYN_geo_movtex_draw_water_regions),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0019C8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(6, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0019F8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(   0, DYN_geo_movtex_pause_control),
      GEO_ASM_DYN(0x0612, DYN_geo_movtex_draw_water_regions),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001A30[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(7, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001C10[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ZBUFFER(1),
      GEO_OPEN_NODE(),
         GEO_CAMERA_FRUSTUM_WITH_FUNC_DYN(64, 50, 6400, DYN_geo_camera_fov),
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(4, 0, 2000, 6000, 0, 0, 0, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE_DYN(10, DYN_geo_switch_area),
               GEO_OPEN_NODE(),
