...
const GeoLayout castle_geo_000F30[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(0, DYN_geo_exec_inside_castle_light),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_000FD0[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(PAINTING_ID(0, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001000[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(2, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001038[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(3, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001088[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(PAINTING_ID(1, 1), DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001200[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_DISPLAY_LIST(LAYER_ALPHA, inside_castle_seg7_dl_07033158),
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(256, DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001260[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_DISPLAY_LIST(LAYER_ALPHA, inside_castle_seg7_dl_07035288),
      GEO_ASM_DYN(  0, DYN_geo_painting_update),
      GEO_ASM_DYN(258, DYN_geo_painting_draw),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_001400[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ZBUFFER(1),
      GEO_OPEN_NODE(),
         GEO_CAMERA_FRUSTUM_WITH_FUNC_DYN(64, 50, 7000, DYN_geo_camera_fov),
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(13, 0, 2000, 6000, 0, 0, 0, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE_DYN(17, DYN_geo_switch_area),
               GEO_OPEN_NODE(),
