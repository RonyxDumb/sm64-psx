...
static const LevelScript script_func_local_1[] = {
    OBJECT_DYN(/*model*/ MODEL_BOWSER_2_TILTING_ARENA, /*pos*/     0,    0,     0, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvTiltingBowserLavaPlatform),
    OBJECT_DYN(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/     4, 1329,  3598, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvBowserBomb),
    OBJECT_DYN(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/  3584, 1329,     0, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvBowserBomb),
    OBJECT_DYN(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/     0, 1329, -3583, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvBowserBomb),
    OBJECT_DYN(/*model*/ MODEL_BOWSER_BOMB,            /*pos*/ -3583, 1329,     0, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvBowserBomb),
    RETURN(),
};
...
const LevelScript level_bowser_2_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_2_geo_000188),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ 0, 2229, 0, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ DYN_bhvSpinAirborneCircleWarp),
