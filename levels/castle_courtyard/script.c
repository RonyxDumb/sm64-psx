...
static const LevelScript script_func_local_1[] = {
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/     0, 200, -1652, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvAmbientSounds),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -2700,   0, -1652, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvBirdsSoundLoop),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/  2700,   0, -1652, /*angle*/ 0, 0, 0, /*behParam*/ 0x00010000, /*beh*/ DYN_bhvBirdsSoundLoop),
    RETURN(),
};

static const LevelScript script_func_local_2[] = {
    OBJECT_DYN(/*model*/ MODEL_BOO, /*pos*/ -3217, 100,  -101, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvCourtyardBooTriplet),
    OBJECT_DYN(/*model*/ MODEL_BOO, /*pos*/  3317, 100, -1701, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvCourtyardBooTriplet),
    OBJECT_DYN(/*model*/ MODEL_BOO, /*pos*/   -71,   1, -1387, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvCourtyardBooTriplet),
    RETURN(),
};
...
const LevelScript level_castle_courtyard_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO_DYN(MODEL_COURTYARD_SPIKY_TREE,  DYN_spiky_tree_geo),
    LOAD_MODEL_FROM_GEO_DYN(MODEL_COURTYARD_WOODEN_DOOR, DYN_wooden_door_geo),
    LOAD_MODEL_FROM_GEO(MODEL_LEVEL_GEOMETRY_03,     castle_courtyard_geo_000200),

    AREA(/*index*/ 1, castle_courtyard_geo_000218),
        OBJECT_DYN(/*model*/ MODEL_BOO,  /*pos*/ -2360, -100, -2712, /*angle*/ 0,   0, 0, /*behParam*/ 0x01050000, /*beh*/ DYN_bhvBooWithCage),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/     0,   51, -1000, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ DYN_bhvLaunchStarCollectWarp),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/     0,   51, -1000, /*angle*/ 0, 180, 0, /*behParam*/ 0x000B0000, /*beh*/ DYN_bhvLaunchDeathWarp),
