...
static const LevelScript script_func_local_1[] = {
    OBJECT_DYN(/*model*/ MODEL_CAP_SWITCH, /*pos*/   0, -2047, 10, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvCapSwitch),
    RETURN(),
};

static const LevelScript script_func_local_2[] = {
    OBJECT_DYN(/*model*/ MODEL_NONE,       /*pos*/ 800, -1700,  0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvHiddenRedCoinStar),
    RETURN(),
};
...
const LevelScript level_totwc_entry[] = {
    ...
    AREA(/*index*/ 1, totwc_geo_000188),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -4095, 2935, 0, /*angle*/ 0, 90, 0, /*behParam*/ 0x000A0000, /*beh*/ DYN_bhvFlyingWarp),
