...
static const LevelScript script_func_local_1[] = {
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/  3996, -2739,  5477, /*angle*/ 0, 0, 0, /*behParam*/ 0x00520000, /*beh*/ DYN_bhvPoleGrabbing),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -2911,  3564, -3967, /*angle*/ 0, 0, 0, /*behParam*/ 0x00540000, /*beh*/ DYN_bhvPoleGrabbing),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -3258,  3359, -3946, /*angle*/ 0, 0, 0, /*behParam*/ 0x00690000, /*beh*/ DYN_bhvPoleGrabbing),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -2639,  3154, -4369, /*angle*/ 0, 0, 0, /*behParam*/ 0x007D0000, /*beh*/ DYN_bhvPoleGrabbing),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -2980,  4048, -4248, /*angle*/ 0, 0, 0, /*behParam*/ 0x00240000, /*beh*/ DYN_bhvPoleGrabbing),
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -3290,  3636, -4477, /*angle*/ 0, 0, 0, /*behParam*/ 0x004D0000, /*beh*/ DYN_bhvPoleGrabbing),
    RETURN(),
};

static const LevelScript script_func_local_2[] = {
    OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -160, 1950, -470, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ DYN_bhvHiddenRedCoinStar),
    RETURN(),
};
...
const LevelScript level_wmotr_entry[] = {
    ...
    AREA(/*index*/ 1, wmotr_geo_0001F0),
        OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ -67, 2669, -16, /*angle*/ 0, 270, 0, /*behParam*/ 0x000A0000, /*beh*/ DYN_bhvAirborneWarp),
