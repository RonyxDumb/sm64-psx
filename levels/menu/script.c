...
const LevelScript level_main_menu_entry_1[] = {
    ...
    AREA(/*index*/ 1, geo_menu_file_select_strings_and_menu_cursor),
        OBJECT_DYN(/*model*/ MODEL_NONE,         /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ DYN_bhvMenuButtonManager),
        OBJECT_DYN(/*model*/ MODEL_MAIN_MENU_YELLOW_FILE_BUTTON, /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ DYN_bhvYellowBackgroundInMenu),
    ...
    CALL_DYN(/*arg*/ 0, /*func*/ DYN_lvl_init_menu_values_and_cursor_pos),
    CALL_LOOP_DYN(/*arg*/ 0, /*func*/ DYN_lvl_update_obj_and_load_file_selected),
...
const LevelScript level_main_menu_entry_2[] = {
    /*0*/ CALL_DYN(/*arg*/ 0, /*func*/ DYN_lvl_set_current_level),
    ...
    /*14*/ AREA(/*index*/ 2, geo_menu_act_selector_strings),
        /*16*/ OBJECT_DYN(/*model*/ MODEL_NONE, /*pos*/ 0, -100, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ DYN_bhvActSelector),
    ...
    /*31*/ CALL_DYN(/*arg*/ 0, /*func*/ DYN_lvl_init_act_selector_values_and_stars),
    /*33*/ CALL_LOOP_DYN(/*arg*/ 0, /*func*/ DYN_lvl_update_obj_and_load_act_button_actions),
