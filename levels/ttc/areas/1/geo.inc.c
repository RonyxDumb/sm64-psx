...
const GeoLayout ttc_geo_0003B8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            GEO_CAMERA_DYN(2, 0, 2000, 6000, 0, 0, 0, DYN_geo_camera_main),
            GEO_OPEN_NODE(),
               GEO_ASM_DYN(   0, DYN_geo_movtex_pause_control),
               GEO_ASM_DYN(0x1400, DYN_geo_movtex_update_horizontal),
               GEO_ASM_DYN(0x1401, DYN_geo_movtex_update_horizontal),
