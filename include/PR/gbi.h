...
#define G_PORT_QUAD		0x07
#define G_PORT_TRI2		8	/* not implemeted */
...
typedef struct {
	uintptr_t w0;
	uintptr_t w1;
#ifdef TARGET_PC // to allow display list recompilation on PC, need to give extra space
	uintptr_t extra;
	uintptr_t extra2;
#endif
} Gwords;
...
#undef gDPLoadSync
#undef gsDPLoadSync
#undef gDPLoadMultiTile_4b
#undef gsDPLoadMultiTile_4b
#undef gDPSetScissor
#undef gsDPSetScissor
#undef gDPLoadTLUT
#undef gsDPLoadTLUT
#undef gDPSetConvert
#undef gsDPSetConvert
#undef gDPSetTileSize
#undef gsDPSetTileSize
#undef gDPPipelineMode
#undef gsDPPipelineMode
...
#undef gDPSetCombineKey
#undef gsDPSetCombineKey
